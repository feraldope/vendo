...
public enum FundsEnum {
    ...
    public enum FundTheme {Unknown, CD, Cash, Bonds, SP500, Dividends, TotalMarket, SmallCap, MidCap, LargeCap, HealthCare, Balanced, International, Pending}
